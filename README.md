...
- Skills 和提示词模板：[openskill](https://github.com/zhoujiakai/openskill)
...
- [openvision](https://github.com/zhoujiakai/openvision) — 计算机视觉工程合集：YOLOv11 端侧部署与推理、阿里云人脸识别对接
...
- [openskill](https://github.com/zhoujiakai/openskill) — 一组 Skills 和提示词模板，覆盖知识管理、任务看板、深度学习、求职准备、个人 AI 助手等场景
